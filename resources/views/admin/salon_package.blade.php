        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input autocomplete="off" type="number" id="no_of_service" name="no_of_service" class="form-control">
                </div>

                <div class="form-group">
                    <label>No of Package</label>
                    <input autocomplete="off" type="number" id="no_of_package" name="no_of_package" class="form-control">
                </div> 
                
                <div class="form-group">
                    <label>No of Product</label>
                    <input autocomplete="off" type="number" id="no_of_product" name="no_of_product" class="form-control">
                </div> 
...
function Edit(id){
  $.ajax({
    ...
    success: function(data)
    {
      ...
      $('input[name=no_of_service]').val(data.no_of_service);
      $('input[name=no_of_product]').val(data.no_of_product);
      $('input[name=no_of_package]').val(data.no_of_package);
