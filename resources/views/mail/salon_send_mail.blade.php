...
<head>
	...
	<title>Salon Mania Send Email</title>
	<style type="text/css">
		...
		.content .list th {
			text-align: left;
			font-weight: bold;
			border-bottom: 2px #eeb861 solid;
		}
		
		.content .list td {
			padding: 5px 0;
			border-bottom: 1px #eeb861 solid;
		}
		
		.content .list .grand-total td {
			font-weight: bold;
			border-bottom: 2px #eeb861 solid;
			border-top: 1px #eeb861 solid;
		}
		...
		.widget-header td {
			border-bottom: 5px #eeb861 solid;
		}
...
<body style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;margin: 0;padding: 0;background: #fff;color: #b9b9b9;font-family: Helvetica, Arial, sans-serif;font-size: 14px;">
	<table cellpadding="0" cellspacing="0" width="100%" border="0" class="outer" style="background: #fff;" bgcolor="#ffffff">
		<tr>
			<td bgcolor="#eeb861" height="10" class="sub-header">
						...
						<td class="w580" width="580" style="width: 580px;">
							...
							<table class="widget w580" cellpadding="0" cellspacing="0" border="0" align="center" style="width: 580px;">
								<tr class="widget-header">
									<td height="55" style="border-bottom: 5px #eeb861 solid;">
										<h1 style="color: #eeb861;font-family: Helvetica, Arial, sans-serif;font-size: 20px;font-weight: bold;text-transform: uppercase;line-height: 36px;padding-right: 20px;margin: 0;">Sample Text Formatting</h1>
									</td>
								</tr>
								<tr>
								...
								<tr class="widget-content">
									<td>
										<p style="margin: 0;padding: 0;font-size: 14px;line-height: 25px;font-family: Helvetica, Arial, sans-serif;color: #333;">This template lets you select from a range of <a href="#" style="text-decoration: underline;color: #eeb861;">different link text and image</a> formatting for your email content. These are just samples of the formatting you can choose from when you add your content in the next step.</p>

										<h2 style="font-weight: bold;font-size: 16px;color: #eeb861;">This is second level header</h2>
										...
										<table cellpadding="0" cellspacing="0" border="0" align="center" class="button" bgcolor="#eeb861">
											<tr>
				...
				<table cellpadding="0" cellspacing="0" width="640" border="0" class="container" align="center">
					<tr>
						<td height="74" align="center" valign="middle" style="font-size: 14px;line-height: 25px;font-family: Helvetica, Arial, sans-serif;color: #333;">
							Don’t want to receive our newsletter?  <a href="#" style="text-decoration: underline;color: #eeb861;">Unsubscribe</a>
						</td>
					</tr>
				</table>
			</td> -->
